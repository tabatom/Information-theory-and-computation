	...
	COMPLEX*16, DIMENSION(:,:), ALLOCATABLE :: psi1_eval, psi2_eval, psi3_eval
	REAL*8, DIMENSION(:,:), ALLOCATABLE :: psi0_squ, psi0_squ_t
	REAL*8, DIMENSION(:,:), ALLOCATABLE :: psi1_squ, psi2_squ, psi3_squ
...
! ---------- ALLOCATING VARIABLES ----------
	...
	ALLOCATE(psi1_eval(dim_spac,dim_time))
	ALLOCATE(psi2_eval(dim_spac,dim_time))
	ALLOCATE(psi3_eval(dim_spac,dim_time))

	ALLOCATE(psi1_squ(dim_spac,dim_time))
	ALLOCATE(psi2_squ(dim_spac,dim_time))
	ALLOCATE(psi3_squ(dim_spac,dim_time))
