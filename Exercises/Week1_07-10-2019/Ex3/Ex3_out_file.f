...
!	Name of file to be written on
	CHARACTER*40 :: res_file

! Variables to measure the time spent
      REAL*8 :: start_m,finish_m,start_F,finish_F,start_T,finish_T
...
! N.B.: here the dimensions should be acceptable to do a matrix multiplication (i.e. col_L = row_R)
	...
	READ*,col_R
	PRINT*,"Insert the name of the file to write on"
	READ*,res_file

!	Adjusting blank spaces in the file name
	res_file=TRIM(res_file)

!	Opening files
	OPEN(UNIT=50,FILE=res_file,STATUS="unknown")
...
! Checking dimensions of matrices
      ...
      ! Measuring time for Manual operation
...
!	Writing results to file
	WRITE(50,*) "Manual process took:"
	WRITE(50,*) finish_m-start_m
	WRITE(50,*) "Transposed process took:"
	WRITE(50,*) finish_T-start_T
	WRITE(50,*) "Function process took:"
	WRITE(50,*) finish_F-start_F
